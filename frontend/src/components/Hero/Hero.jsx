    ...
    return (
        ...
        <section className={styles.container}>
            <div className={styles.content}>
                ...
                <p className={styles.description}>🎓A final year Computer Science Engineering student at BRCM College of Engineering and Technology, Bahal. And an enthusiastic tech lover on a mission to dive deeper into Full Stack Development.💻</p>
