        ...
        <section className={styles.container} id='education'>
            ...
            <div className={styles.content}>
                ...
                <div className={styles.EducationRight}>
                    <img src={getImageUrl("education/Parhlad_Resume.png")} alt="Me sitting with a laptop" className={styles.EducationImage} />
                    <a href='https://drive.google.com/file/d/1CHoEvzQtes8KzD98QNc3kfl5eIYlT0Y-/view?usp=sharing' className={styles.DownloadBtn} target='_blank'>Download Resume</a>
                </div>
            </div>
        </section>
    )
